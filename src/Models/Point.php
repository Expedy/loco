...
class Point
{
     ...
     * Univeral Coordinated Time (UTC), not local time! Fractional seconds
     ...
     * the characters contained in it. It is up to the receiving application
     * to validate the field before sending it to the GPS.
	 * Original GPX 1.1 attribute.
     * 
	 * @var string|null
	 */
